    ...
    return(
        <div className ="contenedorgigante">
             ...
             <div className="lacuartacaja">
                 ...
                 <div className="textolargo">Actualiza tus datos personales.
Configura tu perfil, nombre, apellido, email, telefono y contraseña. Proporciona informacion a los empleados para que identifiquen con mayor facilidad. Nunca proporciones la contraseña de tu cuenta de TuFast a otro individuo que pregunte por ella.</div>
